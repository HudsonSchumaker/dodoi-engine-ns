...
BUILD		:=	build
SOURCES		:=	src src/engine src/engine/core src/engine/ecs src/engine/ecs/components src/engine/ecs/systems src/engine/event src/engine/gfx src/engine/io src/engine/math src/engine/physics src/engine/sfx
DATA		:=	data
INCLUDES	:=	include
ROMFS		:=	romfs

APP_TITLE   := DodoiEngine
APP_AUTHOR  := Dodoi Lab
